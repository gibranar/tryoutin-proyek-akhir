...
<body>
    ...
    <main>
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            $query = "SELECT * FROM tb_mtk LIMIT 1, 1";
            $result = mysqli_query($connect, $query);
            ...
            $query = "SELECT * FROM tb_mtk LIMIT 2, 1";
            $result = mysqli_query($connect, $query);
            ...
            $query = "SELECT * FROM tb_mtk LIMIT 3, 1";
            $result = mysqli_query($connect, $query);
            ...
            $query = "SELECT * FROM tb_mtk LIMIT 4, 1";
            $result = mysqli_query($connect, $query);
        ...
        ?>
        <form action="mtk_db.php" method="POST" onsubmit="return validateForm()">
            <div class="container">
                <div class="soal">
...
<script>
    ...
    //             alert('Silakan jawab semua pertanyaan sebelum mengirimkan formulir.');
    //             return false;
    //         }
    //     }
    //     return true;
